...
public class ConnectFarmasiAPI {
    public static int hargaTertinggi, countData, jumlahData;
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("\nJumlah Data Obat yang Harganya di Rentang 0 - 2000 : " + jumlahData);
        System.out.println("Harga obat terbesar di rentang 0 - 2000 : " + hargaTertinggi);
    }
}
